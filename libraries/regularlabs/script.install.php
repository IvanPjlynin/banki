...
if ( ! class_exists('RegularLabsInstallerScript'))
{
	...
	class RegularLabsInstallerScript extends RegularLabsInstallerScriptHelper
	{
		...
		private function deleteJoomla3Files()
		{
			$this->delete(
				[
					...
					JPATH_SITE . '/libraries/' . $this->alias . '/src/MobileDetect.php',
		...
		private function deleteOldFiles()
		{
			$this->delete(
				[
					JPATH_SITE . '/libraries/' . $this->alias . '/src/Conditions.php',
					JPATH_SITE . '/libraries/' . $this->alias . '/src/Form/Field/ConditionField.php',
					JPATH_SITE . '/libraries/' . $this->alias . '/src/Form/Field/ConditionSelectionField.php',
				]
			);
		}
	}
