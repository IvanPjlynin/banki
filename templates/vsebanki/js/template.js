...
jQuery(document).ready(function ($) {
    ...
    $("#summa-kredita-ot-from-109").val(0).trigger("input");
    $("#summa-kredita-ot-to-109").val(500000).trigger("input");
    ...
    if ($('.form-ipotec-calc').length > 0) {
        let calcIpoteca = {
            ...
            calc: function () {
                ...
                this.params["itogo-summ"] = this.params["mes-plateg"] * this.params["srock-mec"];
            ...
            setRenderFormData: function () {
                ...
                $('.modal .summ-credit').html(this.digits_int2(this.params["summ-credit"]));
                ...
                $('.modal .sroc-credit').html(this.params["srock-ipoteca"]);
                $('.modal .stavca-credit').html(this.params["stavka-procentu"]);
            },
            go: function () {
