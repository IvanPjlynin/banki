...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#summa-kredita-ot-from-137").trigger("keypress").val(function(i, val) {
            return 0;
        });
        ...
        $("#srok-ot-from-137").trigger("keypress").val(function(i, val) {
            return 0;
        });
        ...
        $("#vozrast-from-137").trigger("keypress").val(function(i, val) {
            return 14;
        });
        ...
        $("#vozrast-dlya-pogasheniya-from-137").trigger("keypress").val(function(i, val) {
            return 65;
        });

        $("#vozrast-dlya-pogasheniya-to-137").trigger("keypress").val(function(i, val) {
            return 99;
        });
