    ...
    <div class="jlcontentfieldsfilter<?php echo $moduleclass_sfx; ?> row">
        ...
        <div class="jlmf-section filtr-sort">
            ...
            <select id="jlcontentfieldsfilter-ordering-109" name="jlcontentfieldsfilter[ordering]" class="jlmf-select filtr-sort-select">
                ...
                <option value="summ.asc">Кредитный лимит (по возрастанию)</option>
                <option value="summ.desc">Кредитный лимит (по убыванию)</option>
                <option value="stavka.asc">Ставка (по возрастанию)</option>
                <option value="stavka.desc">Ставка (по убыванию)</option>
                <option value="sroc.asc">Льготный период (по возрастанию)</option>
                <option value="sroc.desc">Льготный период (по убыванию)</option>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#vozrast-dlya-pogasheniya-to-142").trigger("keypress").val(function(i, val) {
            return 99;
        });
