...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#summa-kredita-ot-to-139").trigger("keypress").val(function(i, val) {
            return 500000;
        });



        $("#summa-kredita-from-139").trigger("keypress").val(function(i, val) {
            return 500000;
        });

        $("#summa-kredita-to-139").trigger("keypress").val(function(i, val) {
            return 50000000;
        });
        ...
        $("#srok-ot-from-139").trigger("keypress").val(function(i, val) {
            return 0;
        });

        $("#srok-ot-to-139").trigger("keypress").val(function(i, val) {
            return 24;
        });



        $("#srok-from-139").trigger("keypress").val(function(i, val) {
            return 24;
        });

        $("#srok-to-139").trigger("keypress").val(function(i, val) {
            return 1000;
        });
