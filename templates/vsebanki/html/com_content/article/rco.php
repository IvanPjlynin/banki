...
$attribs['style'] = 'none';
?>
<div class="com-content-article rco item-page<?php echo $this->pageclass_sfx; ?> credit kreditnye-karty" itemscope itemtype="https://schema.org/Article">
    <meta itemprop="inLanguage" content="<?php echo ($this->item->language === '*') ? Factory::getApplication()->get('language') : $this->item->language; ?>">
    <?php if ($this->params->get('show_page_heading')) : ?>
    <div class="page-header">
        <h1><?php echo $this->item->extrafields['nazvanie-organizatsii']->value; ?> <?php echo ($this->item->extrafields['nazvanie-produkta']->value) ? ' тариф '.$this->item->extrafields['nazvanie-produkta']->value : '';?></h1>
        <h3>Открыть расчетный счет в <?php echo $this->item->extrafields['nazvanie-organizatsii']->value; ?></h3>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-stavki-tab" role="tabpanel" aria-labelledby="tab-stavki">
                        <div class="row tab-text">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 tab-text-block text-center">
                                <h3 class="tab-text-block-title">Платежи на счета в других банках</h3>
