...
<div class="item-content row eq ipoteka" data-summ='<?php echo $this->item->extrafields['summa-ipoteka']->value; ?>' data-stavka='<?php echo $this->item->extrafields['stavka-bez-strakhovki-ot-4']->value; ?>' data-sroc='<?php echo $this->item->extrafields['srok-2']->value; ?>' data-id='<?php echo $this->item->id; ?>'>
    ...
    <div class="system-unpublished">
        ...
        <div class="col-12 col-sm-12 col-md-4 column bank-fields">
            ...
            <div class="bank-field stavka">
                ...
                <div class="bank-field-value">от <?php echo $this->item->extrafields['stavka-bez-strakhovki-ot-4']->value; ?> %</div>
            </div>
        </div>
