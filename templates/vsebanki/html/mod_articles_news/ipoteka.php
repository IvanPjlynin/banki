...
<div class="mod-articlesnews newsflash row eq">
    ...
    <div class="col-12 col-sm-12 col-md-4 mod-articlesnews__item" itemscope itemtype="https://schema.org/Article">
        <div class="article-wrapper">
            <?php require ModuleHelper::getLayoutPath('mod_articles_news', '_item-ipoteka'); ?>
        </div>
    </div>
    <?php endforeach; ?>
</div>
<div class="row">
    <div class="col-12 col-sm-12 col-md-4 offset-md-4">
        <a class="articles-button" href="/ipoteka/master-podbora-ipoteki" target="_blank">Все предложения</a>
    </div>
</div>
