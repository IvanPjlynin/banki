	...
	<?php foreach ($list as $item) : ?>
		<div class="col-12 col-sm-12 col-md-4 mod-articlesnews__item" itemscope itemtype="https://schema.org/Article">
			<div class="article-wrapper">
			   <?php require ModuleHelper::getLayoutPath('mod_articles_news', '_item-credit'); ?>
			</div>
		</div>
	<?php endforeach; ?>
</div>
<div class="row">
   <div class="col-12 col-sm-12 col-md-4 offset-md-4">
      <a class="articles-button" href="kredity/kredit-nalichnymi" target="_blank">Все предложения</a>
   </div>
</div>
